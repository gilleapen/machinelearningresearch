...
/**
 *  基于Pairs距离代价函数的 半监督学习
 * 与CostDistanceBasedSSL相比，图构造不同--将邻域图两点的距离改成
 * 两个点各自邻域点内距离之和的差
 * @author huangdongshan
 */
public class CostPairsDistanceBasedSSL extends CollectiveRandomizableClassifier implements
        TechnicalInformationHandler {

    /** Whether to normalize/standardize/neither */
    protected int m_filterType;
    protected CostPairsDistanceBasedSSL m_Parent;
    private CostPairsDistanceBasedSSLInstances m_Data;
...
//        knn.buildClassifier(trainNew);
    ...
    protected void buildClassifier() throws Exception {
        ...
        //利用PairsweightGraph图来进行最短路径学习
        Dijkstra dijkstra = new Dijkstra(PairsweightGraph);
        //扩大代价距离的影响，设置sigma
...
//利用父类的成员变量
        m_Data =
                new CostPairsDistanceBasedSSLInstances(this, m_Trainset, m_Testset);
        //貌似是合并后的数据确实
        m_TrainsetNew =
                m_Data.getTrainSet();
        m_TestsetNew =
    ...
    protected class CostPairsDistanceBasedSSLInstances
         ...
         */
        public CostPairsDistanceBasedSSLInstances(CostPairsDistanceBasedSSL parent, Instances train, Instances test)
                throws Exception {
         ...
         * @return
         */
        private CostPairsDistanceBasedSSL getParent() {
            return m_Parent;
        }
