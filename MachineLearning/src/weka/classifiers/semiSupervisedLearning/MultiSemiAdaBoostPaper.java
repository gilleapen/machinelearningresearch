 ...
 */
public class MultiSemiAdaBoostPaper extends RandomizableIteratedSingleClassifierEnhancer
    ...
    private void setWeights(Instances trainPool, int numberlabeled, double reweightcorrect, double reweightincorrect)
        ...
        while (enu.hasMoreElements()) {
            ...
            if (!correct) {
                ...
                {
                    instance.setWeight(instance.weight()*reweightincorrect * m_luincorrectRate);
                } else {
                    instance.setWeight(instance.weight()*reweightincorrect);//设置分错了的权值
                }
            }
