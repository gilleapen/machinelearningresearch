 ...
 */
public class NewSimpleLogistic
  extends Classifier
  implements OptionHandler, AdditionalMeasureProducer, WeightedInstancesHandler,
     ...
     */
    public NewSimpleLogistic(int numBoostingIterations, boolean useCrossValidation,
    ...
    public static void main(String[] argv) {
        runClassifier(new NewSimpleLogistic(), argv);
    }
}
