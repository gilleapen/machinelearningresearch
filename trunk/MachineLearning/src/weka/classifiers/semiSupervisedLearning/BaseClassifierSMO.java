 ...
 * <br/>
 * For more information on the BaseClassifierSMO algorithm, see<br/>
 * <br/>
 ...
 * <br/>
 * S.S. Keerthi, S.K. Shevade, C. Bhattacharyya, K.R.K. Murthy (2001). Improvements to Platt's BaseClassifierSMO Algorithm for SVM Classifier Design. Neural Computation. 13(3):637-649.<br/>
 * <br/>
 ...
 *    number = {3},
 *    pages = {637-649},
 *    title = {Improvements to Platt's BaseClassifierSMO Algorithm for SVM Classifier Design},
 *    volume = {13},
 *    year = {2001},
 ...
 */
public class BaseClassifierSMO
        extends Classifier
        ...
        protected void fitLogistic(Instances insts, int cl1, int cl2,
            ...
            if (numFolds <= 0) {
                ...
                for (int i = 0; i < numFolds; i++) {
                    ...
                    smo.setKernel(Kernel.makeCopy(BaseClassifierSMO.this.m_kernel));
  ...
  /**
    ...
    public void buildClassifier(Instances traindata) throws Exception {
        ...
        //===============================================================
        //这个地方获得跟半监督学习一样的训练集（用半监督的labeledDataSet代替训练集合）
        //将训练数据分成有标记的和没有标记的数据
        ...
        //训练数据
        Instances insts = splitTrain.getLabledData();
        //===================================================================
        if (!m_checksTurnedOff) {
            ...
            for (int i = 0; i < inst.numClasses(); i++) {
                for (int j = i + 1; j < inst.numClasses(); j++) {
                    if ((m_classifiers[i][j].m_alpha != null) ||
                        ...
                        newInst[1] = Instance.missingValue();
                        r[i][j] = m_classifiers[i][j].m_logistic.distributionForInstance(new Instance(1, newInst))[0];
    ...
    /**
     * Returns the bias of each binary BaseClassifierSMO.
     */
    public double[][] bias() {
    ...
    public static void main(String[] argv) {
        runClassifier(new BaseClassifierSMO(), argv);
    }
}
