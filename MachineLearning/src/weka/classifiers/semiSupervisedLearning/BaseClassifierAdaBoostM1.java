 ...
 */
public class BaseClassifierAdaBoostM1
   ...
   * Constructor.
   */
  public BaseClassifierAdaBoostM1() {
 ...
 /**
  ...
  //===============================================================
        ...
        //将训练数据分成有标记的和没有标记的数据
        SemiBoostSplitTrainSet splitTrain = new SemiBoostSplitTrainSet(data);
  ...
  public static void main(String [] argv) {
    runClassifier(new BaseClassifierAdaBoostM1(), argv);
  }
}
