...
/*
 *    BaseClassifierMultilayerPerceptron.java
 ...
 */
public class BaseClassifierMultilayerPerceptron
  extends Classifier 
  ...
  public static void main(String [] argv) {
    runClassifier(new BaseClassifierMultilayerPerceptron(), argv);
  }
    private int m_Seed=1;
     /**标记的百分比*/
    private double m_percentLabeled = 10.0;

    public void setM_percentLabeled(double m_percentLabeled) {
        this.m_percentLabeled = m_percentLabeled;
    }
    /** 随机分训练集*/
    protected boolean m_randomSplit = false;

    public double getM_percentLabeled() {
   ...
   * The constructor.
   */
  public BaseClassifierMultilayerPerceptron() {
    m_instances = null;
  ...
  public void buildClassifier(Instances traindata) throws Exception {
    ...
    //===============================================================
        ...
        //训练数据
        Instances instances = splitTrain.getLabledData();
       //===================================================================
