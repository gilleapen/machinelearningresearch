 ...
 * @see OptionHandler
 */
public class SeededKMeans extends AbstractClusterer implements OptionHandler,SemiSupClusterer,ActiveLearningClusterer {

  /** Name of clusterer */
  String m_name = "SeededKMeans";
 /** for serialization */
  static final long serialVersionUID = -3235809600124455378L;
  /** holds the clusters */
