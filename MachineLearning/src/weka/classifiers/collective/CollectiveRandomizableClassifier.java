...
/**
 * Abstract classifier for a randomizable collective classifer.
 * 
 * @author  Fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$ 
 */
public abstract class CollectiveRandomizableClassifier 
   ...
   */
  public CollectiveRandomizableClassifier() {
    super();
    initializeMembers();
    reset();
  }
  ...
  /**
   * checks whether the classifier was built and if not performs the build (but 
