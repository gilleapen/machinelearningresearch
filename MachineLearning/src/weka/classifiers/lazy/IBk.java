...
public class IBk
     ...
     * 获得实例的k个近邻的信息，如距离等等
     */
    public void computeKnnInformation(Instance instance) throws Exception {
        ...
        //邻域索引
        m_Indices = m_NNSearch.kNNIndices(instance, m_kNN);
        //邻域对应的距离
        m_Distances = m_NNSearch.getDistances();
    }
